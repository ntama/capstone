                    ...
                    <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div class="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                          <span class="text-gray-600">
                            Capstone Project, by Nick Tama.
                          </span>
                        </div>
                    </div>
                    <div>
                        <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Stock data, straight from the market.</h1>
                        <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">This project served as an educational tool to develop a baseline understanding
                        of Laravel and associated tools.</p>
                        <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">The project currently covers historical stock data
                        from the previous five years up to present day.</p>
